...
get_url = "https://urbangeekz.com/science-tech/"
...
def find_occurrences(content_string):
    start_indices = [i for i in range(len(content_string)) if
                     content_string.startswith('https://urbangeekz.com/science-tech/', i)]
...
def get_all_urls(start_indices, end_indices, content_string):
    ...
    for i in range (len(start_indices)):
        url_lists.append(content_string[start_indices[i]:end_indices[i]])
        return url_lists
